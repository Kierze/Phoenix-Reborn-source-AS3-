...
public class _6T_ extends Sprite implements _0J_p {
    ...
    public function _6T_(_arg1:GameObject, _arg2:String, _arg3:uint, _arg4:Number, _arg5:uint, _arg6:Number, _arg7:uint, _arg8:int, _arg9:Boolean, _arg10:Boolean)
    {
        ...
        this.text_.embedFonts = true; // CHANGED - was true, changed to false so that text shows (there is a problem with embedded fonts)
    ...
    public function draw(_arg1:View, _arg2:int):Boolean {
        ...
        if (((this._vF_) && (!(Parameters.ClientSaveData.textBubbles)))) {
            visible = false;
            return (true);
        }
        visible = true;
