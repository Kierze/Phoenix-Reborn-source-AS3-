...
public class _jz extends _9j {
    ...
    private var _0D_P_:titleTextButton = null;
    private var _0J_C_:SimpleText = null;
    private var _O_b:titleTextButton = null;
    ...
    override public function refresh():void {
        ...
        if (!Account._get().isRegistered()) {
            this._0D_P_ = new titleTextButton("Register", _Y_J_, false);
            this._0D_P_.addEventListener(MouseEvent.CLICK, this._mO_);
            this._O_b = new titleTextButton("Log in", _Y_J_, false);
            this._O_b.addEventListener(MouseEvent.CLICK, this._02G_);
        } else {
            this._cY_.text = (Account._get().guid() + " - ");
            this._0D_P_ = new titleTextButton("Log out", _Y_J_, false);
