...
//TooltipComparisons.CompareRogueAbilityTooltip

package TooltipComparisons {
public class CompareRogueAbilityTooltip extends TooltipComparison {
    ...
    private function _O_J_(itemXML:XML):void {
        ...
        if (itemXML.@id == "Cloak of the Planewalker") {
            _t4 = (_t4 + ColorText("Teleport to Target\n", _purple));
            teleportTag = XML(itemXML.Activate.(text() == "Teleport"))[0];
            DictionaryA[teleportTag.toXMLString()] = true;
        }
    }
    ...
    private function _it(_arg1:Number, _arg2:Number):String {
        var _local3 = "";
        var _local4:String = compareValuesToColor((_arg1 - _arg2));
        _local3 = "Effect on Self:\n";
        return ((_local3 + ColorText((("Invisible for " + _arg1) + " secs\n"), _local4)));
    }
