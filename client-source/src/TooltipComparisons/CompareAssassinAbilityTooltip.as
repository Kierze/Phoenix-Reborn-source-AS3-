...
//TooltipComparisons.CompareAssassinAbilityTooltip

package TooltipComparisons {
public class CompareAssassinAbilityTooltip extends TooltipComparison {
    ...
    override protected function compareSlots(itemXML:XML, curItemXML:XML):void {
        ...
        if ((((activate.length() == 1)) && ((otherActivate.length() == 1)))) {
            ...
            _t4 = (_t4 + ("Poison Grenade: " + ColorText(text, compareValuesToColor((avg - otherAvg)))));
            DictionaryA[activate[0].toXMLString()] = true;
        }
    }
