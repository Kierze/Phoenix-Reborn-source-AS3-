...
//TooltipComparisons.CompareWarriorAbilityTooltip

package TooltipComparisons {
public class CompareWarriorAbilityTooltip extends TooltipComparison {
    ...
    private function _gU_():void {
        ...
        _t4 = (_t4 + ("Party Effect: " + ColorText(_local7, compareValuesToColor((_local5 - _local6)))));
        DictionaryA[this._0F_P_.toXMLString()] = true;
    }
    ...
    private function _0I_P_():void {
        ...
        if (((!((this.speedy == null))) && (!((this._vs == null))))) {
            ...
            _t4 = (_t4 + ("Effect on Self:\n" + ColorText(_local3, compareValuesToColor((_local1 - _local2)))));
            DictionaryA[this.speedy.toXMLString()] = true;
        } else {
            if (((!((this.speedy == null))) && ((this._vs == null)))) {
                _t4 = (_t4 + ("Effect on Self:\n" + ColorText((("Speedy for " + this.speedy.@duration) + " secs\n"), _green)));
                DictionaryA[this.speedy.toXMLString()] = true;
            }
        }
    }
    ...
    private function _G_q():void {
        if (this._08L_ != null) {
            _t4 = (_t4 + ("Effect on Self:\n" + ColorText((("Armored for " + this._08L_.@duration) + " secs\n"), _purple)));
            DictionaryA[this._08L_.toXMLString()] = true;
        }
    }
