...
//TooltipComparisons.CompareNecromancerAbilityTooltip

package TooltipComparisons {
public class CompareNecromancerAbilityTooltip extends TooltipComparison {
    ...
    override protected function compareSlots(_arg1:XML, _arg2:XML):void {
        ...
        if (((!((_local3 == null))) && (!((_local4 == null))))) {
            ...
            _t4 = (_t4 + ("Steal: " + ColorText((((_local7 + " HP within ") + _local5) + " sqrs\n"), compareValuesToColor((_local9 - _local10)))));
