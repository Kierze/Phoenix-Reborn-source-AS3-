...
//TooltipComparisons.ComparePaladinAbilityTooltip

package TooltipComparisons {
public class ComparePaladinAbilityTooltip extends TooltipComparison {
    ...
    override protected function compareSlots(itemXML:XML, curItemXML:XML):void {
        ...
        if (this._default()) {
            ...
            if (itemXML.@id == "Seal of Blasphemous Prayer") {
                ...
                _t4 = (_t4 + ("Effect on Self:\n" + ColorText((("Invulnerable for " + tag.@duration) + " secs\n"), _purple)));
    ...
    private function _0H_r():void {
        ...
        DictionaryA[this._W_m.toXMLString()] = true;
    }
    ...
    private function _C_r():void {
        ...
        _t4 = (_t4 + ("Party Effect: " + ColorText(_local7, compareValuesToColor((_local5 - _local6)))));
        DictionaryA[this._Z_x.toXMLString()] = true;
    }
