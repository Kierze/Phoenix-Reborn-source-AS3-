...
public class _pM_ extends Sprite {
    ...
    private static const _R_m:Rectangle = new Rectangle(-512, -384, 1024, 768);
    ...
    private function _P_i():_X_l {
        ...
        _local3.setProps((_sl.x_ + (2 * BORDER)), _sl.y_, "Background Map", Background._0H_W_, false, false, "MainTheme");
        _local3.initialize();
    ...
    private function onEnterFrame(_arg1:Event):void {
        ...
        if (MusicHandler.currentName != "Death" || MusicHandler.currentName != "MainTheme") MusicHandler.reload("MainTheme");
