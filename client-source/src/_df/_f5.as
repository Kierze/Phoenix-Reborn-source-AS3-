...
public class _f5 extends Preview {
    ...
    public function _f5(w:int, h:int) {
        super(w, h);
        var walkBitmap:Bitmap = new Bitmap(_bH_.Bitmaps[1]);
        ...
        var standBitmap:Bitmap = new Bitmap(_bH_.Bitmaps[0]);
        ...
        var attackBitmap:Bitmap = new Bitmap(_bH_.Bitmaps[2]);
    ...
    override public function redraw():void {
        ...
        this._yN_ = new _lJ_(new MaskedBitmap(_lT_, null), (_lT_.width / 7), _lT_.height, _lJ_.RIGHT);
        this._yu();
    }
    ...
    protected function _yu():void {
        ...
        var _local2:MaskedBitmap = this._yN_.imageFromDir(_lJ_.RIGHT, this.action_, _local1);
        bitmap_.bitmapData = TextureRedrawer.redraw(_local2.image_, size_, true, 0, false);
        position();
    }
