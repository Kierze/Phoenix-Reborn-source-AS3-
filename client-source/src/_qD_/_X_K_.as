...
public class _X_K_ extends _E_b {
    ...
    override public function loadBitmapData(_arg1:BitmapData):void {
        ...
        if (_arg1.width <= 16) {
            ...
            this._zO_[_wo._sS_].loadBitmapData(BitmapUtil.getRectanglefromBitmap(_arg1, 0, 0, _local3, _local4));
            this._zO_[_wo.WALK1].loadBitmapData(BitmapUtil.getRectanglefromBitmap(_arg1, _local3, 0, _local3, _local4));
            this._zO_[_wo.WALK2].loadBitmapData(BitmapUtil.getRectanglefromBitmap(_arg1, (_local3 * 2), 0, _local3, _local4));
            this._zO_[_wo.ATTACK1].loadBitmapData(BitmapUtil.getRectanglefromBitmap(_arg1, (_local3 * 4), 0, _local3, _local4));
            this._zO_[_wo.ATTACK2].loadBitmapData(BitmapUtil.getRectanglefromBitmap(_arg1, (_local3 * 5), 0, (_local3 * 2), _local4));
        }
