...
internal class _5N_ extends Sprite {
    ...
    private function _0H_3(_arg1:MouseEvent):void {
        var _local2:TwoButtonDialog = new TwoButtonDialog((((("Are you sure you want to promote " + this.name_) + " to ") + _07E_._0C_n(_07E_._0H_q(this._S_e))) + "?"), ("Promote " + this.name_), "Cancel", "Promote", "/promote");
        _local2.addEventListener(TwoButtonDialog.BUTTON1_EVENT, this._0C_f);
        _local2.addEventListener(TwoButtonDialog.BUTTON2_EVENT, this._ep);
    ...
    private function _P_w(_arg1:MouseEvent):void {
        var _local2:TwoButtonDialog = new TwoButtonDialog((((("Are you sure you want to demote " + this.name_) + " to ") + _07E_._0C_n(_07E_._4J_(this._S_e))) + "?"), ("Demote " + this.name_), "Cancel", "Demote", "/demote");
        _local2.addEventListener(TwoButtonDialog.BUTTON1_EVENT, this._0C_f);
        _local2.addEventListener(TwoButtonDialog.BUTTON2_EVENT, this._gy);
        stage.addChild(_local2);
    }
    ...
    private function _Q_2(_arg1:MouseEvent):void {
        var _local2:TwoButtonDialog = new TwoButtonDialog((("Are you sure you want to remove " + this.name_) + " from the guild?"), ("Remove " + this.name_), "Cancel", "Remove", "/removeFromGuild");
        _local2.addEventListener(TwoButtonDialog.BUTTON1_EVENT, this._0C_f);
        _local2.addEventListener(TwoButtonDialog.BUTTON2_EVENT, this._uy);
        stage.addChild(_local2);
    }
