...
public class MarketplaceSlot extends Sprite {
        ...
        public function redraw() {
            ...
            if(this.item_ != -1) {
                var _local2:XML = ObjectLibrary.typeToXml[this.item_];
                ...
                var _local5:Point = _H_K_(this.item_, ObjectLibrary.getSlotType(this.item_), false);
        ...
        private function onMouseOver(e:MouseEvent):void {
            this._9();
            if(this.item_ != -1 && ObjectLibrary.typeToId(this.item_) != null) {
