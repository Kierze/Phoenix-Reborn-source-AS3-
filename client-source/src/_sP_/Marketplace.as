...
public class Marketplace extends Sprite {
    ...
    public function Marketplace(_arg1:int, _arg2:int, _arg3:GameSprite, _arg4:String) {
        ...
        this._j7.y = ((768 / 2) - (this._j7.height / 2));
        addChild(this._j7);
    ...
    private function build(_arg1:XML):void {
        ...
        _local2.beginFill(0);
        _local2.drawRect(0, 0, _5N_.WIDTH, 600);
        _local2.endFill();
    ...
    private function _A_E_(_arg1:Event):void {
        this._0A_z.y = (-(this._E_k._Q_D_()) * ((this._0A_z.height + 12) - 600));
    }

    private function _B_E_(_arg1:Event):void {
        this._0A_z.y = (-(this._E_k._Q_D_()) * ((this._0A_z.height + 70) - 600));
    }
    ...
    private function checkScroll(event:Event):void {
        ...
        if (this._0A_z.height > 600) {
            ...
            this._E_k.x = ((1024 - this._E_k.width) - 4);
            this._E_k.y = 110;
            this._E_k._fA_(600, this._0A_z.height + 70);
