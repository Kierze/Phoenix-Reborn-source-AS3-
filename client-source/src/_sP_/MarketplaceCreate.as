...
public class MarketplaceCreate extends Sprite {
        ...
        private var createButton_:Button;
        ...
        public function build():void {
            ...
            this._P_V_.y = 24;
            stage;
            this._P_V_.x = ((1024 / 2) - (this._P_V_.width / 2));
            addChild(this._P_V_);
            this._dL_ = new Shape();
            ...
            this.arrow_.x = this.myInv_.x + this.myInv_.width + 28;
            this.arrow_.y = this.myInv_.y + (this.myInv_.height / 2) - (this.arrow_.height / 2) - 2;
            this._0A_z.addChild(this.arrow_);
            this.request_ = new MarketplaceItemSelect(this.gs_);
            this.request_.setType("marketCreate");
            this.request_.x = 34;
            this.request_.y = this.arrow_.y + (this.arrow_.height / 2) - 46;
            this._0A_z.addChild(this.request_);
            this.request_.addEventListener(Event.CHANGE, checkScroll);
            this.createButton_ = new Button(24, "Create");
        ...
        private function _A_E_(_arg1:Event):void {
            this._0A_z.y = (-(this._E_k._Q_D_()) * (this._0A_z.height - 600));
        }
