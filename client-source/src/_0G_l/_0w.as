...
public class _0w extends Sprite {
    ...
    private function _W_k():void {
        ...
        this._yN_ = new _lJ_(new MaskedBitmap(this.bitmapData_, null), _local1, _local2, _lJ_.RIGHT);
    ...
    private function _Y_A_():void {
        ...
        var _local4:MaskedBitmap = this._yN_.imageFromDir(_lJ_.RIGHT, _local2, _local3);
        this.bitmap_.bitmapData = TextureRedrawer.redraw(_local4.image_, 100, true, 0, true);
        this.bitmap_.x = ((WIDTH / 2) - (this.bitmap_.width / 2));
        this.bitmap_.y = (((HEIGHT / 2) - (this.bitmap_.height / 2)) - 10);
    }

    private function _g1():void {
        var _local1:_lJ_ = AnimatedTextures._J_v("players", 0);
        var _local2:MaskedBitmap = _local1.imageFromDir(_lJ_.RIGHT, _lJ_._sS_, 0);
        ...
        _local3 = TextureRedrawer.outlineGlow(_local3, 0);
    ...
    private function _B_K_():void {
        ...
        toolTip_ = new TextTagTooltip(Parameters._primaryColourDefault, 0x9B9B9B, this.name_, _local2, 200);
