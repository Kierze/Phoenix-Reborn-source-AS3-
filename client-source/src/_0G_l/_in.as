...
public class _in extends Sprite {
    ...
    public function _in() {
        ...
        this._wu = new Button(16, "Search", 120);
        ...
        this._uv = new DropdownList(new <String>["Mine", "All", "Phoenix"], 120, 30);
        this._uv.x = 20;
        this._uv.y = 40;
        ...
        this.__var = new DropdownList(_local1, 120, 30);
    ...
    protected var _wu:Button;
    protected var _0B_e:TextButton;
    protected var _07v:TextButton;
    protected var _p2:_0G_s;
    protected var _uv:DropdownList;
    protected var __var:DropdownList;
    ...
    private function draw():void {
        ...
        stage;
        this.box_.x = ((1024 / 2) - (this.box_.width / 2));
        stage;
        this.box_.y = ((768 / 2) - (this.box_.height / 2));
    ...
    private function _fs(_arg1:_32):void {
        ...
        _local2.addEventListener(TwoButtonDialog.BUTTON1_EVENT, this._0B_L_);
        _local2.addEventListener(TwoButtonDialog.BUTTON2_EVENT, this.onDelete);
        addChild(_local2);
    }
    ...
    private function _0B_L_(_arg1:Event):void {
        var _local2:TwoButtonDialog = (_arg1.target as _r4);
