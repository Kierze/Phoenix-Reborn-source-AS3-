...
import com.company.PhoenixRealmClient.screens.charrects.CurrentCharacterRect;
import com.company.PhoenixRealmClient.ui.InGameSideBarUI;
...
public class _K_a implements _v {
    ...
    public function configure():void {
        ...
        this.mediatorMap.map(ServersView)._Y_u(_N_N_);
        ...
        this.mediatorMap.map(TitleView)._Y_u(__for);
    ...
    private function _m6():void {
        ...
        this.mediatorMap.map(InGameSideBarUI)._Y_u(_B_9);
    }
