...
public class TwoButtonDialog extends Sprite {
    ...
    public function TwoButtonDialog(_arg1:String, _arg2:String, _arg3:String, _arg4:String, _arg5:String) {
        ...
        if (_arg3 != null) {
            this.button1_ = new Button(16, _arg3, 120);
            this.button1_.addEventListener(MouseEvent.CLICK, this.onButton1Click);
        }
        if (_arg4 != null) {
            this.button2_ = new Button(16, _arg4, 120);
    ...
    protected var button1_:Button = null;
    protected var button2_:Button = null;
