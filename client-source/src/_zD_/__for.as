...
public class __for extends _cM_ {
    ...
    private function _04P_():void {
        var _local1:TwoButtonDialog;
        var _local2:_07V_;
        if (((Parameters.isTesting) && ((this._eJ_._T_1.servers_.length == 0)))) {
            if (Parameters.domainCheck()) {
                _local1 = new TwoButtonDialog(((("There are currently no testing servers available.  " + 'Please play on <font color="#7777EE">') + '<a href="http://phoenix-realms.com/">') + "phoenix-realms.com</a></font>."), "No Testing Servers", null, null, "/noTestingServers");
            } else {
                _local1 = new TwoButtonDialog((((("Phoenix Realms 2 Alpha is currently offline.\n\n" + "Go here for more information:\n") + '<font color="#7777EE">') + '<a href="http://phoenix-realms.com">') + "phoenix-realms.com</a></font>."), "Woops, no servers here!", null, null, "/offLine");
            }
            this.view.stage.addChild(_local1);
            return;
        }
        if (((Parameters.ClientSaveData.needsTutorial) && ((this._eJ_._T_1.nextCharId_ == 1)))) {
            Parameters.ClientSaveData.playerObjectType = 770;
            Parameters.save();
            _local2 = new _07V_();
            _local2._0_E_ = true;
    ...
    private function _uz():void {
        navigateToURL(new URLRequest("http://phoenix-realms.com/"), "_blank");
    }
