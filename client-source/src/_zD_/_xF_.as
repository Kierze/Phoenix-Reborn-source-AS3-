...
public class _xF_ extends _cM_ {
    ...
    private function _T_Q_():void {
        ...
        if (Parameters.ClientSaveData.lastDailyAnalytics != _local1) {
            _local2 = new _fn();
            _local2.category = "joinDate";
            _local2._lC_ = Parameters.ClientSaveData.joinDate;
            this._o_.dispatch(_local2);
            Parameters.ClientSaveData.lastDailyAnalytics = _local1;
            Parameters.save();
        }
    }
