...
public class EnterPortalPanel extends Panel {

    public function EnterPortalPanel(_arg1:GameSprite, _arg2:Portal) {
        super(_arg1);
        this._iA_ = _arg2;
    ...
    private function enterPortal():void {
        var _local1:String = ObjectLibrary.typeToDisplayId[this._iA_.objectType_];
