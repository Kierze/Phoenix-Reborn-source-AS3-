...
//_R_v.PlayerNearbyPanel

package Panels {
import Tooltips.OtherPlayerTooltip;

import _0D_B_.OtherUserOptionsMenu;
...
public class PlayerNearbyPanel extends Panel
{
    public function PlayerNearbyPanel(_arg1:GameSprite)
    {
        this._X_T_ = new Vector.<CharObjectHeader>(PlayerNearbyList._tn, true);
        super(_arg1);
    ...
    public var _X_T_:Vector.<CharObjectHeader>;
    private var toolTip_:OtherPlayerTooltip = null;
    private var _0G_Y_:OtherUserOptionsMenu = null;
    ...
    override public function draw():void
    {
        ...
        var _local7:Number;
        var _local8:int;
        var _local1:PlayerNearbyList = gs_.map_.party_;
        if (_local1 == null)
        {
        ...
        var _local2:int;
        var _local3:int;
        while (_local3 < PlayerNearbyList._tn)
        {
    ...
    private function _00Y_(_arg1:int, _arg2:int):CharObjectHeader
    {
        var _local3:CharObjectHeader = new CharObjectHeader(0xFFFFFF, false, null);
        addChild(_local3);
        _local3.x = _arg1;
        _local3.y = _arg2;
        return (_local3);
    ...
    private function onMouseOver(_arg1:MouseEvent):void
    {
        ...
        var _local2:CharObjectHeader = (_arg1.target as CharObjectHeader);
        var _local3:Player = (_local2.go_ as Player);
        if ((((_local3 == null)) || ((_local3.texture_ == null))))
        {
            return;
        }
        this.toolTip_ = new OtherPlayerTooltip(_local3);
    ...
    private function onMouseDown(_arg1:MouseEvent):void
    {
        ...
        this._7C_();
        var _local2:CharObjectHeader = (_arg1.target as CharObjectHeader);
        this._0G_Y_ = new OtherUserOptionsMenu(gs_, (_local2.go_ as Player));
