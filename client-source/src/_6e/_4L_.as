...
public class _4L_ extends Sprite {
    ...
    private var _I_4:TwoButtonDialog;
    ...
    private function load():void {
        ...
        this._I_4 = new TwoButtonDialog("Loading...", null, null, null, null);
        addChild(this._I_4);
    ...
    private function show():void {
        ...
        this._0_0.x = ((1024 / 2) - (this._0_0.w_ / 2));
        this._0_0.y = ((768 / 2) - (this._0_0.h_ / 2));
    ...
    private function _0D_0(_arg1:Event):void {
        ...
        this._X_A_.x = ((1024 / 2) - (this._X_A_.w_ / 2));
        this._X_A_.y = ((768 / 2) - (this._X_A_.h_ / 2));
    ...
    private function _P_c(_arg1:Event):void {
        ...
        removeChild(this._X_A_);
        this._X_A_ = null;
        this._I_4 = new TwoButtonDialog("Saving...", null, null, null, null);
        addChild(this._I_4);
        this._T_y.visible = false;
    }
