...
public class TrapEffect extends ObjectEffect {

    public function TrapEffect(_arg1:GameObject, _arg2:Number, _arg3:int) {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        while (_local6 < _local4) {
            ...
            _local10 = new MovingDecayParticle(_local3, this.color_, _local5, _local9, _local8);
