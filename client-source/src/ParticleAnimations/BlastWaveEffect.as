...
public class BlastWaveEffect extends ObjectEffect {

    public function BlastWaveEffect(_arg1:GameObject, _arg2:Position, _arg3:Number, _arg4:int) {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        while (_local8 < _local6) {
            ...
            _local11 = new MovingDecayParticle(_local3, this.color_, _local4, this.start_, _local10);
