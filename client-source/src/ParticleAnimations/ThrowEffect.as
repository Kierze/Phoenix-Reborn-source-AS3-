...
public class ThrowEffect extends ObjectEffect {
...
import ParticleAnimations.Particle;
...
class ThrowParticle extends Particle {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        map_.addObj(new DecayParticle((100 * (z_ + 1)), color_, 400, z_, _04d._F_e(1), _04d._F_e(1)), this.pathX_, this.pathY_);
        return (true);
    }
