...
public class MovingDecayParticle extends Particle {

    public function MovingDecayParticle(_arg1:int, _arg2:int, _arg3:int, _arg4:Point, _arg5:Point) {
        super(_arg2, 0, _arg1);
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        map_.addObj(new DecayParticle((100 * (z_ + 1)), color_, 600, z_, _04d._F_e(1), _04d._F_e(1)), this.pathX_, this.pathY_);
        return (true);
    }
