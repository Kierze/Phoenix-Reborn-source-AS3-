...
public class PotionEffect extends ObjectEffect {

    public function PotionEffect(_arg1:GameObject, _arg2:uint) {
        this.go_ = _arg1;
        this.color_ = _arg2;
    }
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        while (_local4 < _local3) {
            ...
            _local8 = new MovingParticle(this.color_, (Math.random() * 0.3), _local6, 1000, (0.1 + (Math.random() * 0.1)), this.go_, _local5, _local7);
