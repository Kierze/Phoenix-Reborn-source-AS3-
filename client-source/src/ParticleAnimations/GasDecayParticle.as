...
public class GasDecayParticle extends DecayParticle {

    public function GasDecayParticle(_arg1:int, _arg2:int, _arg3:int, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number) {
        this._H_s = _arg4;
