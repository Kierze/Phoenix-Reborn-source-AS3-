...
public class QuadSpaceConcentrate extends ObjectEffect
    {
        private var squareArea:Number;
        private var intensity:Number;
        private var host:GameObject;
        private var properties:XmlEffectProperties;
        ...
        public function QuadSpaceConcentrate(_arg1:XmlEffectProperties, _arg2:GameObject)
        {
            this.host = _arg2;
