...
public class AreaBlastEffect extends ObjectEffect {

    public function AreaBlastEffect(_arg1:GameObject, _arg2:Number, _arg3:int) {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        while (_local6 < _local5) {
            ...
            _local9 = new MovingDecayParticle(_local3, this.color_, _local4, this.start_, _local8);
