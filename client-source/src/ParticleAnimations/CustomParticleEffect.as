...
public class CustomParticleEffect extends ObjectEffect {

    public function CustomParticleEffect(_arg1:XmlEffectProperties, _arg2:GameObject) {
        this._J_7 = _arg2;
        this._L_1 = new Vector.<OrbitObject>();
        this.__try = new Vector.<OrbitObject>();
        this._0G_x = _arg1;
        if (this._0G_x.bitmapFile) {
            this.bitmapData = AssetLibrary.getBitmapFromFileIndex(this._0G_x.bitmapFile, this._0G_x.bitmapIndex);
            this.bitmapData = TextureRedrawer.redraw(this.bitmapData, this._0G_x.size, true, 0);
        } else {
            this.bitmapData = TextureRedrawer.redrawSolidSquare(this._0G_x.color, this._0G_x.size);
        }
    }
    public var cloud_:Boolean = false;
    private var _L_1:Vector.<OrbitObject>;
    private var __try:Vector.<OrbitObject>;
    private var _J_7:GameObject;
    private var _0E_I_:Number = 0;
    private var _ge:Number = 0;
    private var _0G_x:XmlEffectProperties;
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        var _local4:Number;
        var _local7:int;
        var _local8:OrbitObject;
        var _local9:OrbitObject;
        ...
        while (_local7 < _local6) {
            if (this._L_1.length) {
                ...
                _local8 = new OrbitObject(_local13);
            }
            ...
            if (this._0G_x.bitmapFile) {
                ...
                _local13 = AssetLibrary.getBitmapFromFileIndex(this._0G_x.bitmapFile, uint(_local12));
                _local13 = TextureRedrawer.redraw(_local13, this._0G_x.size, true, 0);
            } else {
        ...
        while (_local7 < this.__try.length) {
            ...
            if (_local9._G_n <= 0) {
                ...
                if(this.cloud_ && (_local9.pOwnerX_ != this._J_7.x_ || _local9.pOwnerY_ != this._J_7.y_)) {
                    ...
                    var _local13:BitmapData;
                    if (this._0G_x.bitmapFile) {
                        _local13 = AssetLibrary.getBitmapFromFileIndex(this._0G_x.bitmapFile, _local9.bitmapIndex_);
                        _local13 = TextureRedrawer.redraw(_local13, _local9._size, true, 0);
                    } else {
