...
public class HealingEffect extends ObjectEffect {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        if (_local3 > 500) {
            ...
            _local7 = new MovingParticle(0xFFFFFF, (Math.random() * 0.3), _local5, 1000, (0.1 + (Math.random() * 0.1)), this.go_, _local4, _local6);
