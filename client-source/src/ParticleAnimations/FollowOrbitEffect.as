...
public class FollowOrbitEffect extends ObjectEffect {
    ...
    public function FollowOrbitEffect(_arg1:XmlEffectProperties, _arg2:GameObject) {
      this._origin = _arg2;
      this.xmlDat = _arg1;
      this.angle_ = this.xmlDat.angleOffset;
      if (this.xmlDat.bitmapFile) {
        this.bitmapData = AssetLibrary.getBitmapFromFileIndex(this.xmlDat.bitmapFile, this.xmlDat.bitmapIndex);
    ...
    private var xmlDat:XmlEffectProperties;
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
      ...
      this.mainParticle._0H_B_ = map_.getSquare(this.mainParticle.x_, this.mainParticle.y_);
      return (true);
    }
