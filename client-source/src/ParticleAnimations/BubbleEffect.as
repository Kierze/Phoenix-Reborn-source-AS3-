...
public class BubbleEffect extends ObjectEffect {

    private static const _F_r:Number = 400;

    public function BubbleEffect(_arg1:GameObject, _arg2:XmlEffectProperties) {
        this.go_ = _arg1;
        this._25 = _arg2;
    ...
    private var _25:XmlEffectProperties;
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        while (_local10 < _local4) {
            ...
            _local11 = BubbleParticle.create(this._0A_x, this._25.color, this._25.speed, this._25.life, this._25.lifeVariance, this._25.speedVariance, this._25.spread);
