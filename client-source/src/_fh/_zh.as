...
public class _zh extends Sprite {
    ...
    public function _zh(_arg1:_X_l) {
        ...
        super();
        this.map_ = _arg1;
        this._gh = new Vector.<_A_p>(PlayerNearbyList._tn, true);
        var _local2:int;
        while (_local2 < PlayerNearbyList._tn) {
            _local3 = new _A_p();
    ...
    public function draw(_arg1:View, _arg2:int):void {
        ...
        var _local3:PlayerNearbyList = this.map_.party_;
        var _local4:Player = this.map_.player_;
        var _local5:int;
        while (_local5 < PlayerNearbyList._tn) {
            ...
            if (!_local6._68) {
                if (_local5 >= _local3._X_e.length) {
                    ...
                    if (((((_local7._1D_) || ((_local7.map_ == null)))) || (_local7.dead))) {
                        _local6._bz(null);
                    } else {
                        _local6._bz(_local7);
                        _local8 = 0;
