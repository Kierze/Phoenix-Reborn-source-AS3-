...
public class _kW_ extends _05p {
    ...
    public function _kW_() {
        ...
        this._cv = new SpriterObjectTypeDropdownList();
        this._cv.x = _0B_Q_;
        this._cv.y = _04e;
    ...
    private var _cv:SpriterObjectTypeDropdownList;
    private var _kq:_2i;
    ...
    private function _pO_():void {
        ...
        switch (_local1) {
            case SpriterObjectTypeDropdownList._0D_a:
                this._kq = new _b1_T_();
                break;
            case SpriterObjectTypeDropdownList._hM_:
                this._kq = new _B_T_();
                break;
            case SpriterObjectTypeDropdownList._C_a:
                this._kq = new _0G_g();
                break;
        }
    ...
    private function _set_(_arg1:_07k):void {
        ...
        switch (_arg1.type_) {
            case _D_Z_._04B_:
                this._cv.setValue(SpriterObjectTypeDropdownList._hM_);
                break;
            case _D_Z_._xU_:
                this._cv.setValue(SpriterObjectTypeDropdownList._C_a);
                break;
            default:
                this._cv.setValue(SpriterObjectTypeDropdownList._0D_a);
        }
