...
package _F_1 {
import Tooltips.ClassQuestRankTooltip;
...
public class _05p extends Sprite {
    ...
    private var _B_D_:StarRankSprite;
    ...
    private function _0H_l():void {
        this._B_D_ = new StarRankSprite(this.stars, true, false);
        this._B_D_.x = 36;
        this._B_D_.y = 4;
    ...
    public function initialize(_arg1:_0K_R_):void {
        ...
        stage;
        this._0_4.x = ((1024 - this._0_4.width) - 10);
        this._0_4.y = 2;
    ...
    protected function onMouseOver(_arg1:MouseEvent):void {
        this.tooltip.dispatch(new ClassQuestRankTooltip(this.stars));
    }
