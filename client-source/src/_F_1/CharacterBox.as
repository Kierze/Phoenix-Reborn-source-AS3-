...
package _F_1 {
import Tooltips.CharacterMenuTooltip;
...
import com.company.graphic.FullCharBoxGraphic;
import com.company.graphic.LockedCharBoxGraphic;
...
public class CharacterBox extends Sprite {
    ...
    public function CharacterBox(_arg1:XML, _arg2:ClassStat, _arg3:_0K_R_)
    {
        var _local4:Bitmap;
        var _local5:Sprite;
        super();
        ...
        if (!this._F_I_) {
            ...
            this._L_B_.y = 58 - 6;
            addChild(this._L_B_);
            this.classNameText_.y = 72;
        } else {
            _local5 = this._kU_(ClassQuest.getFameGoalsCompleted(this.charList_._0D_E_(this.objectType())), ClassQuest.FameGoals.length);
            _local5.y = 58;
    ...
    public var charStats_:ClassStat;
    ...
    public function getTooltip():TooltipBase {
        return (new CharacterMenuTooltip(this.playerXML_, this.charList_, this.charStats_));
    }
