...
public class titleTextButton extends Sprite {
    ...
    public function titleTextButton(_arg1:String, _arg2:int, _arg3:Boolean, _arg4:uint=0xFFFFFF) {
        name = _arg1;
        this.text_ = new SimpleText(_arg2, _arg4, false, 0, 0, "Myriad Pro");
