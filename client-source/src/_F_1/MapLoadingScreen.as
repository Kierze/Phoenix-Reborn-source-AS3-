...
public class MapLoadingScreen extends Sprite {
    ...
    public function display(_arg1:MapInfoPacket, _arg2:int, _arg3:BitmapData, _arg4:BitmapData):void {
    ...
    private function _b(_arg1:_kd):void {
        ...
        charContainer.x = (1024 / 2) - (charContainer.width / 2);
        charContainer.y = (768 / 2) - ((charContainer.height / 2) + 50);
