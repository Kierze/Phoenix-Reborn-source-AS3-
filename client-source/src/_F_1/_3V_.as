...
import com.company.PhoenixRealmClient.ui._00A_;
import com.company.PhoenixRealmClient.ui._Q_y;
    ...
    private function _3J_(_arg1:Sprite, _arg2:Number):void {
        ...
        if (this._0A_z.height > 600) {
            ...
            if (_arg2 != Number.MIN_VALUE) {
                this._E_k._0D__(((_arg2 - 200) / (this._0A_z.height - 600)));
            }
        } else {
            this._E_k.visible = false;
        }
