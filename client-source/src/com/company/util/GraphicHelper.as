...
public class GraphicHelper {
    ...
    public static function drawBorder(sprite:Sprite, colour:uint, thickness:Number, alpha:Number):void{
        var gfx:Graphics = sprite.graphics;

        gfx.lineStyle(thickness, colour, alpha);

        gfx.lineTo(sprite.width - thickness, 0);
        gfx.lineTo(sprite.width - thickness, sprite.height - thickness);
        gfx.lineTo(0, sprite.height - thickness);
        gfx.lineTo(0, 0);
    }
}
}//package com.company.util
