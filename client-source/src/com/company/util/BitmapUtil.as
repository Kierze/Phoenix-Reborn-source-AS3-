...
public class BitmapUtil {
    ...
    public static function getRectanglefromBitmap(_arg1:BitmapData, startX:int, startY:int, xSize:int, ySize:int):BitmapData
    {
        var output:BitmapData = new BitmapData(xSize, ySize);
        output.copyPixels(_arg1, new Rectangle(startX, startY, xSize, ySize), new Point(0, 0));
        return (output);
    }
        ...
        while (_local4 < _arg1.width) {
            ...
            while (_local8 < _arg1.width) {
                ...
                if ((_local3 & 0xFF000000) != 0) {
                    if (!_local2.hasOwnProperty(String(_local3))) {
                        _local2[_local3] = 1;
                    } else {
                        var _local10 = _local2;
                        var _local11 = _local3;
                        _local10[_local11] = (_local10[_local11] + 1);
                    }
                }
                _local8++;
            }
