...
public class ServerConnection extends EventDispatcher {
    ...
    public function DefineMsg(_arg1:uint, _arg2:Class, _arg3:Function):void {
        this.messages[_arg1] = new MessageType(_arg2, _arg3);
    }
    ...
    public function sendMessage(_arg1:Packet):void {
        this._aG_.push(_arg1);
        this._0I_3();
    }

    public function _Y_E_(_arg1:uint):Packet {
        var _local2:MessageType = this.messages[_arg1];
        if (_local2 == null) {
            return (null);
        }
        var _local3:Packet;
    ...
    public function _fj(_arg1:Packet):void {
        this.messages[_arg1.id_].freeList_.push(_arg1);
    }
    ...
    private function _vL_(event:ProgressEvent):void {
        ...
        while (1) {
            ...
            this.messages[messageId].callback_(message);
            this._fj(message);
        }
    }
