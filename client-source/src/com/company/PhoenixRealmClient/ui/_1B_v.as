...
public class _1B_v extends Sprite {
    ...
    public function _1B_v() {
        ...
        addChild(_Zx_);
        var _local2:BitmapData = AssetLibrary.getBitmapFromFileIndex("lofiObj3", 239);
    ...
    private var _silver:int = -1;

    public function draw(_arg1:int):void {
        if ((_arg1 === this._silver)){
            return;
        }
        this._silver = _arg1;
        this._3q.x = -(this._3q.width);
        this._Zx_.text = this._silver.toString();
