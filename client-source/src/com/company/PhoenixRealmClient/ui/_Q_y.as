...
//com.company.PhoenixRealmClient.ui._Q_y
...
public class _Q_y extends Sprite {
    ...
    public function _Q_y(_arg1:Boolean, _arg2:int, _arg3:XML) {
        ...
        addChild(this._30);
        _local5 = ObjectLibrary.typeToXml[int(_arg3.ObjectType)];
        ...
        _local10 = TextureRedrawer.outlineGlow(_local10, 0);
        _local10 = BitmapUtil.getRectanglefromBitmap(_local10, 6, 6, (_local10.width - 12), (_local10.height - 6));
        ...
        this._4N_ = ConversionUtil.StringCommaSplitToIntVector(_arg3.Equipment);
        this._4N_.length = 4;
        var _local11:Vector.<int> = ConversionUtil.StringCommaSplitToIntVector(_local5.SlotTypes);
        _local11.length = 4;
        ...
        addChild(this._D_a);
        var _local12:BitmapData = AssetLibrary.getBitmapFromFileIndex("lofiObj3", 224);
        this._0H_ = new Bitmap(TextureRedrawer.redraw(_local12, 40, true, 0));
        this._0H_.x = 652;
