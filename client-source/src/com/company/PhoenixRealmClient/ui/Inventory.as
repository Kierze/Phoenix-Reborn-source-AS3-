...
//com.company.PhoenixRealmClient.ui.Inventory
...
public class Inventory extends Sprite {
    ...
    public function Inventory(_arg1:GameSprite, _arg2:GameObject, _arg3:String, _arg4:Vector.<int>, _arg5:int, _arg6:Boolean, _offset:int = 0, _equipment:Boolean = false, _oneWay:int=0):void {
        var _local8:_E_6;
        this.slots_ = new Vector.<_E_6>();
        this.fill_ = new GraphicsSolidFill(Parameters._primaryColourLight);
