...
//com.company.PhoenixRealmClient.ui._E_6
...
public class _E_6 extends Slot {
    ...
    private static const _soulLootBag:String = "Soulbound Loot Bag";
    private static const _lootBag:String = "Loot Bag";
    private static const _personalChest:String = "Vault Chest";
    private static const _inventory:String = "Inventory";
    private static const _treasureChest:String = "Treasure Chest";
    protected static const _P_r:Array = [new ColorMatrixFilter([0.4, 0, 0, 0, 0, 0, 0.4, 0, 0, 0, 0, 0, 0.4, 0, 0, 0, 0, 0, 1, 0])];

    public static var toolTip_:TooltipBase;
    ...
    public function _t8(_arg1:int):Boolean
    {
        ...
        var _local2:int = ObjectLibrary.getSlotType(_arg1);
    ...
    public function _0E_J_():void {
        ...
        if ((((this.objectType_ == -1)) || ((type_ == anySlot)))) {
            this._cX_ = false;
        } else {
        ...
        var _local2:int = ObjectLibrary.getSlotType(this.objectType_);
        var _local3:Point = equipmentDrawOffset(this.objectType_, _local2, false);
    ...
    public function attemptUse():void {
        ...
        if ((((_local2 == null)) || (_local2._EntityIsPausedEff()))) {
            return;
        }
    ...
    private function _X_6():void {
        ...
        var player:Player = this._e9.gs_.map_.player_;
        var _local2:Boolean = ObjectLibrary.objectIsForPlayer(this.objectType_, player) && ObjectLibrary.checkLevelRequirement(this.objectType_, player);
        ...
        //this.itemData_ = this.playerInventory._iA_ != null ? this.playerInventory._iA_.equipData_[this.id_] : null;
    }
    ...
    private function _i9():void {
        toolTip_ = new TextTagTooltip(Parameters._primaryColourDefault, 0x9B9B9B, null, (("Empty " + this._5I_()) + " slot"), 200);
    }

    private function _H_T_():void {
        var _local1:Boolean = this._e9._mK_();
        if (ObjectLibrary.typeToId(this.objectType_) != null)
    ...
    private function _00W_():void {
        ...
        if (this._I_N_()) {
            _local1 = this._v5();
            _local2 = ObjectLibrary.checkEquipSlotTypes(this.objectType_, _local1);
            _local3 = ObjectLibrary.typeToXml[this.objectType_];
            _local4 = _local3.SlotType;
            if (_local2) {
                _local5 = 0;
                while (_local5 < 4) {
                    if (_local1.inventorySlotTypes_[_local5] == _local4) {
                        _local6 = this._A_P_();
    ...
    private function _V_q():void {
        ...
        var _local2:Boolean = ObjectLibrary.checkEquipSlotTypes(this.objectType_, _local1);
        var _local8:Boolean = ObjectLibrary.checkLevelRequirement(this.objectType_, _local1);
        var _local3:XML = ObjectLibrary.typeToXml[this.objectType_];
    ...
    private function _W_4():Boolean {
        return ((((((((this._e9._A_H_ == _lootBag)) || ((this._e9._A_H_ == _personalChest)))) || ((this._e9._A_H_ == _soulLootBag)))) || ((this._e9._A_H_ == _treasureChest))));
    }
    ...
    private function _0A_v(_arg1:_E_6):void {
        ...
        var _local3:GameConnection = this._gw();
        var _local4:Player = this._v5();
        //_local3.invSwap(_local2, _local4.x_, _local4.y_, this.playerInventory._iA_.objectId_, this.id_, this.objectType_, _arg1.playerInventory._iA_.objectId_, _arg1.id_, _arg1.objectType_);
    ...
    private function _gw():GameConnection {
    ...
    private function _A_P_():Inventory {
        return (this._e9.gs_.HudView._02y.playerInventory);
    }

    private function equipInv():Inventory {
        return (this._e9.gs_.HudView._02y.InvEquips);
    }
    ...
    private function _W_(_arg1:TimerEvent):void {
        if (Parameters.ClientSaveData["contextualClick"] == false) {
            return;
        }
        if (this._O_W_ > 0) {
            if (this._X_B_) {
