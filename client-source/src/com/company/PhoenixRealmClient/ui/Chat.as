...
//com.company.PhoenixRealmClient.ui.Chat

package com.company.PhoenixRealmClient.ui {
    import Frames.DogmanFrame;
...
public class Chat extends Sprite {
    ...
    public function Chat(_arg1:GameSprite, _arg2:int, _arg3:int) {
        this._eU_ = [];
    ...
    private function _2T_(_arg1:String):Boolean {
        if (_arg1 == "/?") {
            ...
            return true;
        } else if (_arg1 == "/dogman") {
            this.gs_.addChild(new Frame2Holder(new DogmanFrame()));
            return true;
        }
        return false;
    }
    ...
    private function _H_H_(_arg1:KeyboardEvent):void {
        switch (_arg1.keyCode) {
            case Parameters.ClientSaveData.chatCommand:
                if (stage.focus == null) {
                    this._0C_X_();
                    this._bn.text = "/";
                    this._bn.setSelection(this._bn.length, this._bn.length);
                ...
                return;
            case Parameters.ClientSaveData.chat:
                if (stage.focus == null) {
                    this._0C_X_();
                }
                return;
            case Parameters.ClientSaveData.tell:
                if (stage.focus == null) {
                    this._0C_X_();
                }
                this._03z(_arg1.shiftKey);
                return;
            case Parameters.ClientSaveData.guildChat:
                if (stage.focus == null) {
                    this._0C_X_();
                    this._bn.text = "/g ";
                    this._bn.setSelection(this._bn.length, this._bn.length);
                ...
                return;
            case Parameters.ClientSaveData.partyChat:
                if (stage.focus == null) {
                    this._0C_X_();
                    this._bn.text = "/p ";
                    this._bn.setSelection(this._bn.length, this._bn.length);
                ...
                return;
            case Parameters.ClientSaveData.scrollChatUp:
                if (!this._O_C_) {
                    this._O_C_ = true;
                } else {
                ...
                this._x5();
                return;
            case Parameters.ClientSaveData.scrollChatDown:
                if (this._zS_ == 0) {
                    this._O_C_ = false;
                } else {
