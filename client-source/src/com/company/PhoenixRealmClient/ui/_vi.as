...
//com.company.PhoenixRealmClient.ui._vi
...
public class _vi {
    ...
    public function _vi() {
        ...
        this.BlackColour = this._yz();
        this.BlackColour.color = 0x363636; //idk what this is for -proph
        ...
        this.ChatBotColour = this._yz();
        this.ChatBotColour.color = 0x55D695;
    }
    ...
    public var ChatBotColour:ElementFormat = null;
    public var BlackColour:ElementFormat = null;
