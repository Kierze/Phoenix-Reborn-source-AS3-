...
//com.company.PhoenixRealmClient.ui._0K_B_
...
public class ScrollBar extends Sprite {
    ...
    private static function _G_k(_arg1:int, _arg2:int, _arg3:Graphics):void {
        ...
        _arg3.endFill();
        _arg3.beginFill(Parameters._primaryColourLight, 1);
    ...
    public function ScrollBar(width:int, height:int, speed:Number = 1) {
        this._vV_ = new GraphicsSolidFill(Parameters._primaryColourLight, 1);
    ...
    public function resize(_arg1:int, _arg2:int, _arg3:Number = 1):void {
        ...
        _local5.clear();
        _local5.beginFill(Parameters._primaryColourDefault, 1);
