...
//com.company.PhoenixRealmClient.ui._0M_Y_
...
public class StatsBar extends Sprite {

    public static var options_:Signal = new Signal(Boolean);

    public function StatsBar(_arg1:int, _arg2:int, _arg3:uint, _arg4:uint, _arg5:String = null) {
        ...
        this._08m = new SimpleText(12, 0xFFFFFF, false, 0, 0, "CHIP SBKI");
        ...
        if (!(Parameters.ClientSaveData.toggleBarText)) {
    ...
    public function _Y_r(_arg1:Boolean, _arg2:int):void {
        if (_arg1) {
            ...
            addChild(this._5B_);
            this._W_K_(3, 0x90DC1B, 0xFFFFFF);
        } else {
            if (this._5B_.parent) {
    ...
    private function _0E_J_():void {
        ...
        if ((Parameters.ClientSaveData.toggleBarText) || ((this._68) && (this.h_ > 4))) {
            if (this._05E_ > 0) {
                if (Parameters.ClientSaveData.togglePercentage) {
            ...
            if (this.boost_ != 0 && !Parameters.ClientSaveData.togglePercentage) {
