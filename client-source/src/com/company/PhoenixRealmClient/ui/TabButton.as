...
public class TabButton extends Sprite {
    ...
    public function TabButton(_icon:BitmapData, _selected:Boolean, _tabId:int) {
        ...
        this.iconRaw_ = _icon;
        this.icon_ = TextureRedrawer.redraw(this.iconRaw_, (320 / this.iconRaw_.width), true, 0);
    ...
    public function updateFill(_selected:Boolean):void {
        this.fill_ = new GraphicsSolidFill(_selected ? Parameters._primaryColourDark : Parameters._primaryColourLight, 1);
