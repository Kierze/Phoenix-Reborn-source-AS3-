...
//com.company.PhoenixRealmClient.ui.Minimap

package com.company.PhoenixRealmClient.ui {
import Tooltips.MouseOverOtherPlayerTooltip;

import _0D_B_._06M_;

import com.company.PhoenixRealmClient.map._X_l;
import com.company.PhoenixRealmClient.map._pf;
import com.company.PhoenixRealmClient.objects.Character;
...
import com.company.PhoenixRealmClient.objects.Portal;
...
public class Minimap extends Sprite {
    ...
    public function Minimap(_arg1:_X_l, _arg2:int, _arg3:int) {
        ...
        this._0H_x = AssetLibrary.getBitmapFromFileIndex("lofiInterface", 54);
        ...
        addChild(this._16);
        this._tk = new Sprite();
        _local6 = new Bitmap(AssetLibrary.getBitmapFromFileIndex("lofiInterface", 54));
        _local6.scaleX = 2;
        _local6.scaleY = 2;
        ...
        addChild(this._tk);
        this._1_ = new Sprite();
        _local6 = new Bitmap(AssetLibrary.getBitmapFromFileIndex("lofiInterface", 55));
        _local6.scaleX = 2;
        _local6.scaleY = 2;
    ...
    private var toolTip_:MouseOverOtherPlayerTooltip = null;
    ...
    public function draw():void {
        ...
        for each (_local10 in this.map_.goDict_) {
            if (!((_local10.props_.noMiniMap) || ((_local10 == this.map_.player_)))) {
                _local16 = (_local10 as Player);
                if (_local16 != null) {
                    if (_local16._EntityIsPausedEff()) {
                        _local15 = 0x7F7F7F;
                    } else {
                        if (_local16.inParty) {
                            _local15 = 0xFFFF;
        ...
        if (this._nC_.length != 0) {
            if (this.toolTip_ == null) {
                this.toolTip_ = new MouseOverOtherPlayerTooltip(this._nC_);
        ...
        this._P_T_.rotate(Parameters.ClientSaveData.cameraAngle);
