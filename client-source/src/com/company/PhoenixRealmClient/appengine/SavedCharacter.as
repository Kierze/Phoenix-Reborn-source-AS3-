...
//com.company.PhoenixRealmClient.appengine.SavedCharacter
...
public class SavedCharacter {
    ...
    public static function getImage(_arg1:SavedCharacter, _arg2:XML, _arg3:int, _arg4:int, _arg5:Number, _arg6:Boolean, _arg7:Boolean):BitmapData {
        ...
        var _local8:_lJ_ = AnimatedTextures._J_v(String(_arg2.AnimatedTexture.File), int(_arg2.AnimatedTexture.Index));
        if (_skin != -1) {
            var _skinx:XML = ObjectLibrary.typeToXml[_arg1.skin()];
            if (_skinx != null)
                _local8 = AnimatedTextures._J_v(String(_skinx.AnimatedTexture.File), int(_skinx.AnimatedTexture.Index));
        }
        var _local9:MaskedBitmap = _local8.imageFromDir(_arg3, _arg4, _arg5);
    ...
    public static function _N_Q_(_arg1:SavedCharacter, _arg2:SavedCharacter):Number {
        var _local3:Number = ((Parameters.ClientSaveData.charIdUseMap.hasOwnProperty(_arg1.charId())) ? Parameters.ClientSaveData.charIdUseMap[_arg1.charId()] : 0);
        var _local4:Number = ((Parameters.ClientSaveData.charIdUseMap.hasOwnProperty(_arg2.charId())) ? Parameters.ClientSaveData.charIdUseMap[_arg2.charId()] : 0);
        if (_local3 != _local4) {
    ...
    public function _jp():String {
        return (ObjectLibrary.typeToDisplayId[this.objectType()]);
    }

    public function spec():String {
        return (this._iJ_.Specialization);
    }

    public function mood():String {
        return (this._iJ_.Mood);
    }
