...
//com.company.PhoenixRealmClient.objects.Wall

package com.company.PhoenixRealmClient.objects {

import com.company.PhoenixRealmClient.engine3d.Face3D;
...
public class DoubleWall extends GameObject {
    ...
    public function DoubleWall(_arg1:XML) {
        ...
        super(_arg1);
        _P_m = false;
        var _local2:TextureFromXML = ObjectLibrary.typeToTopTexture[objectType_];
    ...
    override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:View, _arg3:int):void {
        ...
        while (_local5 < this.faces_.length) {
            ...
            if ((((((_local8 == null)) || ((_local8.texture_ == null)))) || (((((!((_local8 == null))) && ((_local8.obj_ is DoubleWall)))) && (!(_local8.obj_.dead)))))) {
                _local7._0z = true;
            } else {
                _local7._0z = false;
                if (_09e != null) {
