...
//com.company.PhoenixRealmClient.objects.ConnectedWall

package com.company.PhoenixRealmClient.objects {
import com.company.PhoenixRealmClient.engine3d.ObjectFace3D;
...
public class ConnectedWall extends ConnectedObject {
    ...
    override protected function buildDot():void {
        ...
        if (this._I_z.hasOwnProperty("DotTexture")) {
            _local9 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.DotTexture.File), int(this._I_z.DotTexture.Index));
        }
    ...
    override protected function buildShortLine():void {
        ...
        if (this._I_z.hasOwnProperty("ShortLineTexture")) {
            _local9 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.ShortLineTexture.File), int(this._I_z.ShortLineTexture.Index));
        }
    ...
    override protected function buildL():void {
        ...
        if (this._I_z.hasOwnProperty("LTexture")) {
            _local13 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.LTexture.File), int(this._I_z.LTexture.Index));
        }
    ...
    override protected function buildLine():void {
        ...
        if (this._I_z.hasOwnProperty("LineTexture")) {
            _local9 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.LineTexture.File), int(this._I_z.LineTexture.Index));
        }
    ...
    override protected function buildT():void {
        ...
        if (this._I_z.hasOwnProperty("TTexture")) {
            _local17 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.TTexture.File), int(this._I_z.TTexture.Index));
        }
    ...
    override protected function buildCross():void {
        ...
        if (this._I_z.hasOwnProperty("CrossTexture")) {
            _local25 = AssetLibrary.getBitmapFromFileIndex(String(this._I_z.CrossTexture.File), int(this._I_z.CrossTexture.Index));
        }
