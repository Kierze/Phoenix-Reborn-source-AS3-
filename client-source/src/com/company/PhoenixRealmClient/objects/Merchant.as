...
//com.company.PhoenixRealmClient.objects.Merchant
...
public class Merchant extends SellableObject implements IPanelProvider {
    ...
    override public function soldObjectName():String {
        return (ObjectLibrary.typeToDisplayId[this._0E_]);
    }

    override public function soldObjectInternalName():String {
        var _local1:XML = ObjectLibrary.typeToXml[this._0E_];
    ...
    override public function getIcon():BitmapData {
        ...
        var _local2:XML = ObjectLibrary.typeToXml[this._0E_];
    ...
    public function getSkinId(_arg1:int, player:Player):int {
        ...
        if (_local2.Activate == "UnlockSkin" && _local2.Activate.hasOwnProperty("@skinType")) {
            var _skin:XML = ObjectLibrary.typeToXml[int(_local2.Activate.@skinType)];
            if (_skin == null)
                return _arg1;
