...
import Packets.fromServer.AccountListPacket;
...
public class PlayerNearbyList {
        ...
        public function PlayerNearbyList(_arg1:_X_l) {
            this._X_e = [];
        ...
        public function setStars(_arg1:AccountListPacket):void {
            var _local3:int;
            var _local2:int;
        ...
        public function setIgnores(_arg1:AccountListPacket):void {
            var _local3:int;
            this._0M_w = new Dictionary(true);
            var _local2:int;
            while (_local2 < _arg1.accountIds_.length) {
