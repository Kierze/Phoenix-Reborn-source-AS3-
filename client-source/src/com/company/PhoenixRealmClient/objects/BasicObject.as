...
//com.company.PhoenixRealmClient.objects.BasicObject
...
public class BasicObject {
    ...
    public static function bitShift():int {
    ...
    public function drawShadow(_arg1:Vector.<IGraphicsData>, _arg2:View, _arg3:int):void {
    }

    public function _0E_T_(_arg1:View):void {
        this._050.length = 0;
