...
//com.company.PhoenixRealmClient.screens.charrects.CreateNewCharacterRect
...
public class CreateNewCharacterRect extends CharacterRect {
    ...
    public function CreateNewCharacterRect(_arg1:_0K_R_) {
        ...
        var _local2:XML = ObjectLibrary.playerClassObjects[int((ObjectLibrary.playerClassObjects.length * Math.random()))];
        var _local3:BitmapData = SavedCharacter.getImage(null, _local2, _lJ_.RIGHT, _lJ_._sS_, 0, false, false);
        _local3 = BitmapUtil.getRectanglefromBitmap(_local3, 6, 6, (_local3.width - 12), (_local3.height - 6));
        ...
        if (this.charList_.numStars_ != ClassQuest.GetMaxClassQuests()) {
            ...
            this.taglineText_.text = ((ClassQuest.GetMaxClassQuests() - this.charList_.numStars_) + " Class quests not yet completed");
