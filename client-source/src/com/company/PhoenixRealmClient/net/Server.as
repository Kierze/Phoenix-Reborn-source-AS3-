...
//com.company.PhoenixRealmClient.net.Server
...
public class Server {
    ...
    public function Server(_arg1:String, _arg2:String, _arg3:int, _arg4:GeoCoordinate = null, _arg5:Number = 0, _arg6:Boolean = false):void {
        this.name_ = _arg1;
        this.address_ = _arg2;
        this.port_ = _arg3;
        this.latLong_ = _arg4;
    ...
    public var latLong_:GeoCoordinate;
    ...
    public function setLatLong(_arg1:Number, _arg2:Number):Server{
        this.latLong_ = new GeoCoordinate(_arg1, _arg2);
        return (this);
    }
