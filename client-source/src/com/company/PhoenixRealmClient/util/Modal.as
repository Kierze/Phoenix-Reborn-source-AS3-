...
public class Modal extends Sprite {
    ...
    private const closeButton:xButtonSquare = ObjectLibrary.positionXButtonSquare(Modal.WIDTH);
    private const buyButton:PurchaseButton = new PurchaseButton("Buy for ", 16, 0, Currency.INVALID);
    ...
    public function Modal(_arg1:Signal, _arg2:SellableObject, _arg3:Number, _arg4:GameSprite) {
    ...
    private function _str4865():void{
        ...
        this.y = (_local2 + ((-1 * Modal.HEIGHT) * 0.5));
    ...
    private function _str1776():void{
        addChild(makeModalBackground(Modal.WIDTH, Modal.HEIGHT));
