...
//com.company.PhoenixRealmClient.util._07E_
...
public class _07E_ {
    ...
    public static function _wS_(_arg1:int, _arg2:int):BitmapData {
        ...
        switch (_arg1) {
            case _P_J_:
                _local3 = AssetLibrary.getBitmapFromFileIndex("lofiInterfaceBig", 20);
                break;
            case _uc:
                _local3 = AssetLibrary.getBitmapFromFileIndex("lofiInterfaceBig", 19);
                break;
            case _f3:
                _local3 = AssetLibrary.getBitmapFromFileIndex("lofiInterfaceBig", 18);
                break;
            case _tS_:
                _local3 = AssetLibrary.getBitmapFromFileIndex("lofiInterfaceBig", 17);
                break;
            case _0C_o:
                _local3 = AssetLibrary.getBitmapFromFileIndex("lofiInterfaceBig", 16);
                break;
        }
    ...
    public static function _oO_(_arg1:int):BitmapData {
        var _local2:BitmapData = AssetLibrary.getBitmapFromFileIndex("lofiObj3", 226);
