...
public class ModalBackground extends Sprite {
    ...
    public function draw(_arg1:int, _arg2:int, _arg3:int=0):void{
        ...
        switch (_arg3) {
            case 0:
                graphics.beginFill(Parameters._primaryColourDefault);
                _local5._str2527(0, 0, _local4, graphics);
                graphics.endFill();
                break;
            case 1:
                graphics.lineStyle(1, Parameters._primaryColourDefault, 1, false, LineScaleMode.NORMAL, CapsStyle.NONE, JointStyle.ROUND, 3);
                graphics.beginFill(Parameters._primaryColourDefault, 1);
                ...
                graphics.beginFill(Parameters._primaryColourDefault, 0);
                _local5._str2527(0, 0, _local4, graphics);
                graphics.endFill();
                break;
            case 2:
