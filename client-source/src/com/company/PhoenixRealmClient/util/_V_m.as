...
public class _V_m {
    ...
    private static const _7P_:Vector.<Vector.<AssetFile>> = _sE_();
    ...
    private static function _072(_arg1:BitmapData, _arg2:Rectangle, _arg3:Point, _arg4:Vector.<AssetFile>, _arg5:uint, _arg6:uint, _arg7:uint, _arg8:uint):void {
    ...
    private static function _sE_():Vector.<Vector.<AssetFile>> {
        var _local1:Vector.<Vector.<AssetFile>> = new Vector.<Vector.<AssetFile>>();
        _0E_E_(_local1, AssetLibrary.getAssetFile("inner_mask"), AssetLibrary.getAssetFile("sides_mask"), AssetLibrary.getAssetFile("outer_mask"), AssetLibrary.getAssetFile("innerP1_mask"), AssetLibrary.getAssetFile("innerP2_mask"));
        return (_local1);
    }

    private static function _0E_E_(_arg1:Vector.<Vector.<AssetFile>>, _arg2:AssetFile, _arg3:AssetFile, _arg4:AssetFile, _arg5:AssetFile, _arg6:AssetFile):void {
        var _local7:int;
        for each (_local7 in [-1, 0, 2, 1]) {
            _arg1.push(new <AssetFile>[_0G_q(_arg2, _local7), _0G_q(_arg3, (_local7 - 1)), _0G_q(_arg3, _local7), _0G_q(_arg4, _local7), _0G_q(_arg5, _local7), _0G_q(_arg6, _local7)]);
        }
    }

    private static function _0G_q(_arg1:AssetFile, _arg2:int):AssetFile {
        var _local4:BitmapData;
        var _local3:AssetFile = new AssetFile();
        for each (_local4 in _arg1.Bitmaps) {
