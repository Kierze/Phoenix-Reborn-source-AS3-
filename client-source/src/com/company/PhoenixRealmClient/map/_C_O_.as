...
//com.company.PhoenixRealmClient.map._C_O_
...
public class _C_O_ {
    ...
    public function _C_O_(_arg1:XML) {
        ...
        if (_arg1.hasOwnProperty("Edge")) {
            this._0H_U_ = true;
            this._lK_ = new TextureFromXML(XML(_arg1.Edge));
            if (_arg1.hasOwnProperty("Corner")) {
                this._uk = new TextureFromXML(XML(_arg1.Corner));
            }
            if (_arg1.hasOwnProperty("InnerCorner")) {
                this._03g = new TextureFromXML(XML(_arg1.InnerCorner));
            }
        }
        this._M_e = _arg1.hasOwnProperty("SameTypeEdgeMode");
        if (_arg1.hasOwnProperty("Top")) {
            this._S_7 = new TextureFromXML(XML(_arg1.Top));
            this._003 = new _M_X_();
    ...
    public var _S_7:TextureFromXML = null;
    public var _003:_M_X_ = null;
    private var _lK_:TextureFromXML = null;
    private var _uk:TextureFromXML = null;
    private var _03g:TextureFromXML = null;
