...
//com.company.PhoenixRealmClient.tutorial.Tutorial
...
public class Tutorial extends Sprite {
    ...
    public static const _xX_:String = "Update_";
    ...
    public static const _X_I_:String = "Text_";
    ...
    public function Tutorial(_arg1:GameSprite) {
        ...
        super();
        this.gs_ = _arg1;
        for each (_local2 in DataEmbeds.TutorialUIData.Step) {
        ...
        _local3.drawRect(0, 0, 1024, 768);
        _local3.endFill();
        Parameters.ClientSaveData.needsTutorial = false;
        Parameters.save();
