...
public class Bridge implements GoogleAnalyticsAPI {
    ...
    private function _linkTrackingObject(_arg1:String):void {
        var _jsContainer:String = "_GATracker";
        var _linkTrackingObject_js:XML = <script>
            <![CDATA[
 function( container , target )
 {
    ...
    private function _checkValidTrackingObject(_arg1:String):Boolean {
        var _checkValidTrackingObject_js:XML = <script>
            <![CDATA[
 function(acct)
 {
 ...
 function()
 {
    ...
    private function _injectTrackingObject():void {
        var _injectTrackingObject_js:XML = <script>
            <![CDATA[
 function()
 {
                    try
    ...
    private function _createTrackingObject(_arg1:String):void {
        var _createTrackingObject_js:XML = <script>
            <![CDATA[
 function( acct )
 {
