...
public class Tracker implements GoogleAnalyticsAPI {
    ...
    private function _initData():void {
        ...
        if (!_hasInitData) {
            ...
            _timeStamp = Math.round((new Date().time / 1000));
            if (_debug.verbose) {
                _local1 = "";
