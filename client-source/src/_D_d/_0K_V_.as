...
public class _0K_V_ extends _05p {
    ...
    private static const _r0:int = ((768 - _N_g._0K_6) - 10);
    ...
    public function _0K_V_() {
        ...
        this._09l.x = ((1024 / 2) - (_N_g._0K_6 / 2));
        this._09l.y = _r0;
        addChild(this._09l);
        this._mL_ = new _wY_(this._09l);
        this._mL_.x = 4;
        this._mL_.y = ((768 - _wY_.HEIGHT) - 10);
        addChild(this._mL_);
        this._mu = new DropdownList(new <String>["Ground", "Objects", "Regions"], _E_m.WIDTH, 26);
        ...
        super._0_4.x = ((1024 - super._0_4.width) - 10);
        super._0_4.y = 2;
    }
    public var _kg:_H_4;
    public var _09l:_N_g;
    public var _mL_:_wY_;
    public var _mu:DropdownList;
    ...
    private function _0J_h(_arg1:_11):Object {
        ...
        if (_arg1 != null) {
            ...
            if (_local3[_M_u._S_E_] != -1) {
                _local4 = ObjectLibrary.typeToId(_local3[_M_u._S_E_]);
                _local5 = {"id": _local4};
                if (_arg1._fi != null) {
            ...
            while (_local11 < _local6.right) {
                ...
                if (_local13 != null) {
                    for each (_local15 in _local13) {
                        if (ObjectLibrary.idToType.hasOwnProperty(_local15["id"])) {
                            _local9 = ObjectLibrary.idToType[_local15["id"]];
