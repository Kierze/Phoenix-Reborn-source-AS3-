...
public class _P_u extends Sprite {
    ...
    protected static var toolTip_:TooltipBase = null;
    ...
    protected function _V_B_(_arg1:TooltipBase):void {
        this._X_S_();
        toolTip_ = _arg1;
        if (toolTip_ != null) {
    ...
    protected function getToolTip():TooltipBase {
        return (null);
    }

    private function draw():void {
        graphics.clear();
        var _local1:uint = Parameters._primaryColourDefault;
        if (this.selected_) {
            graphics.lineStyle(1, 0xFFFFFF);
            _local1 = 0x7F7F7F;
        }
        graphics.beginFill(((this._68) ? Parameters._primaryColourLight : Parameters._primaryColourDefault), 1);
