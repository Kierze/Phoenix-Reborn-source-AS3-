...
internal class _N_g extends Sprite {
    ...
    public function _N_g() {
        ...
        this._F_l = AssetLibrary.getBitmapFromFileIndex("invisible", 0);
        this._bd = AssetLibrary.getBitmapFromFileIndex("lofiObj3", 0xFF);
        this.draw();
    ...
    private function _0A_Y_(_arg1:KeyboardEvent):void {
        switch (_arg1.keyCode) {
            ...
            case Keyboard.DOWN:
                this.moveDown();
                break;
            case keyboardKeys._0F_K_:
                this._Z_b();
                break;
            case keyboardKeys._0E_f:
                this._cm();
                break;
        }
        this.draw();
