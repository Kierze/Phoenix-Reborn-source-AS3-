...
public class _9o extends TooltipBase {
    ...
    public function _9o(_arg1:XML) {
        ...
        if (_arg1.hasOwnProperty("Enemy")) {
            ...
            if (_arg1.hasOwnProperty("Resilience")) {
                _local2 = (_local2 + (("Resilience: " + _arg1.Defense) + "\n"));
            }
        }
        ...
        for each (_local3 in _arg1.Projectile) {
            ...
            if (_local3.hasOwnProperty("Penetration")) {
                _local2 = (_local2 + "\tPenetration:" + _local3.Penetration + "\n");
            }
