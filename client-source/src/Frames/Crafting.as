...
public class Crafting extends Frame2 {
    ...
    public function Crafting(param1:GameSprite, param2:GameObject) {
        ...
        super("Craft items", "Craft", 250);
        this.inventory_ = new Inventory(param1, param2, "Crafting Inventory", param2.inventorySlotTypes_, 8, false);
        var _loc3_:* = 250 / 2 - this.inventory_.width / 2 - 5;
        this.gs_ = param1;
        this.obj_ = param2;
        this.addDisplayObject(this.inventory_, _loc3_);
