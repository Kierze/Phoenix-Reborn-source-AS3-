...
public class _A__ extends Sprite implements _xY_ {
    ...
    private static const _K_A_:int = Parameters._primaryColourLight;
    private static const _00O_:int = Parameters._primaryColourDefault;
    private static const _9O_:int = Parameters._primaryColourDark;
    ...
    private function _o():void {
        var _local1:Bitmap;
        this._zZ_ = AssetLibrary.getBitmapFromFileIndex("lofiObj3", 225);
        this._zZ_ = TextureRedrawer.redraw(this._zZ_, 50, true, 0, false);
        this._zZ_ = BitmapUtil.getRectanglefromBitmap(this._zZ_, 8, 8, (this._zZ_.width - 16), (this._zZ_.height - 16));
