...
public class TextInput extends Sprite {
    ...
    public function TextInput(_arg1:String, _arg2:Boolean, _arg3:String) {
        ...
        graphics.lineStyle(2, Parameters._primaryColourLight, 1, false, LineScaleMode.NORMAL, CapsStyle.ROUND, JointStyle.ROUND);
        graphics.beginFill(Parameters._primaryColourDark, 1);
