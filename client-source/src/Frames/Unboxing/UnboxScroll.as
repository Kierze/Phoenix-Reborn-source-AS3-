...
public class UnboxScroll extends Sprite {
    ...
    public function UnboxScroll(_scrollSpeed:Number, _itemTypes:Vector.<int>, _itemDatas:Vector.<Object>) {
        this.scrollSpeed_ = _scrollSpeed;
        this.itemTypes_ = _itemTypes;
        this.itemDatas_ = _itemDatas;
    ...
    private function draw():void {
        ...
        var _local3:Vector.<IGraphicsData> = new <IGraphicsData>[_local1, _local2, GraphicHelper.END_FILL];
        GraphicHelper.drawTriangle(WIDTH / 2 - 5, 0, 10, 5, false, _local2);
        graphics.drawGraphicsData(_local3);
        GraphicHelper._0L_6(_local2);
        GraphicHelper.drawTriangle(WIDTH / 2 - 5, HEIGHT - 5, 10, 5, true, _local2);
        graphics.drawGraphicsData(_local3);
    }
    ...
    private function initSquares():void {
        ...
        for(var i:int=0;i<itemTypes_.length;i++) {
            var _local1:UnboxSquare = new UnboxSquare(this.itemTypes_[i], this.itemDatas_[i], i);
