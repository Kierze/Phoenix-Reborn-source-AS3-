...
public class LockedMoodRect extends RectangleSprite {

    private static var toolTip_:TooltipBase = null;
    public static const WIDTH:int = 250;
    public static const HEIGHT:int = 50;

    public function LockedMoodRect(_type:int) {
    ...
    private function makeNameText():void {
        this._nameText = new SimpleText(18, 0xB3B3B3, false, 0, 0, "Myriad Pro");
    ...
    private function makeTaglineText():void {
        ...
        this.taglineText.text = "Not Available!";
    ...
    override protected function onMouseOver(_arg1:MouseEvent):void {
        ...
        this.removeToolTip();
        toolTip_ = new MoodRectTooltip(this.Type, false);
