...
public class CheckBox extends Sprite {
    ...
    public function CheckBox(_arg1:String, _arg2:Boolean, _arg3:String) {
        this._0J_B_ = _arg2;
        this._8n = new Sprite();
        this._8n.x = 2;
        this._8n.y = 2;
    ...
    private function _pi():void {
        ...
        _local1.clear();
        _local1.beginFill(Parameters._primaryColourDark, 1);
        ...
        _local1.lineStyle(2, Parameters._primaryColourLight, 1, false, LineScaleMode.NORMAL, CapsStyle.ROUND, JointStyle.ROUND);
        _local1.drawRect(0, 0, _02K_, _02K_);
        _local1.lineStyle();
    }
