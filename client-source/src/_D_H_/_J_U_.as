...
public class _J_U_ extends Sprite {
    ...
    public function _J_U_(_arg1:String, _arg2:int, _arg3:String, _arg4:BitmapData, _arg5:Vector.<int>) {
        ...
        this._8n = new CheckBox("Save as Admin", false, "");
        this._8n.x = 96;
        this._8n.y = 87;
        if (Player.isAdmin)
            this.box_.addChild(this._8n);
    ...
    protected var _8n:CheckBox = null;
    protected var _0H_b:_2V_ = null;
    protected var _92:_0J_3 = null;
    protected var _B_k:Button = null;
    protected var _t3:Button = null;
