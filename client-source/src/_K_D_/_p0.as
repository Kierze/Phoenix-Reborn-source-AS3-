...
public class _p0 {
    ...
    public static function _0L_k(_arg1:String):_X_l {
        ...
        _local3.setProps(_local2["width"], _local2["height"], _local2["name"], _local2["back"], false, false, "MainTheme");
        _local3.initialize();
    ...
    public static function _A_s(_arg1:Object):GameObject {
        var _local2:int = ObjectLibrary.idToType[_arg1["id"]];
                ...
                if (!(((((((_local8 < 0)) || ((_local8 >= _arg2.width_)))) || ((_local7 < 0)))) || ((_local7 >= _arg2.height_)))) {
                    ...
                    if (_local10 != null) {
                        for each (_local12 in _local10) {
                            ...
                            _local13.objectId_ = BasicObject.bitShift();
