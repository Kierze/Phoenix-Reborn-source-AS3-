...
public class SFXHandler {
        ...
        public static function load(_arg1:String):Sound {
            ...
            var _local3:URLRequest = new URLRequest("http://" + Parameters.musicUrl_ + "/sfx/" + Parameters.ClientSaveData.currentSoundPack + "/" + _arg1 + ".mp3");
            _local2 = new Sound();
        ...
        public static function play(name:String, volume:Number = 1, isFX:Boolean = true):void {
            ...
            try {
                actualVolume = ((((((Parameters.ClientSaveData.playSFX) && (isFX))) || (((!(isFX)) && (Parameters.ClientSaveData.playPewPew))))) ? volume : 0);
        ...
        public static function _02r():void {
            ...
            for each (_local1 in channels) {
                ...
                _local2.volume = ((Parameters.ClientSaveData.playSFX) ? _04b[_local1] : 0);
