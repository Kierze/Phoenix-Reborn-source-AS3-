...
namespace server.account
{
    ...
    internal class sendVerifyEmail : RequestHandler
    {
        ...
        protected override void HandleRequest()
        {
            ...
            string accessKey = "name:" + Guid + "pass:" + Password;
            string hash = GetMd5Hash(md5Hash, accessKey);

            using (var db = new Database(Program.Settings.GetValue("conn")))
            {
                db.InsertEmail(Guid, Password, hash);
            ...
            <td class='navbar navbar-inverse' align='center'>
                <table width='650px' cellspacing='0' cellpadding='3' class='container' style='width:auto;margin:0;padding:0;'>
                    <tr class='navbar navbar-inverse'>
                        <td><a style='margin:0px -3px;text-decoration:none;display: block;padding: 20px;font-size: 20px;font-weight: 200;color: rgb(241,241,241);text-shadow: 0px -1px 1px rgba(0, 0, 0, 0.55);' href='http://example.forum.phoenixrealms.com'>Forums</a></li></ul></td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table width='650px' cellspacing='0' cellpadding='3' class='container' style='width:960px;'>
                    <tr>
                        <td align='center' style='font-size:12pt;'>
                            ...
                            <p style='height:80px;margin-bottom:35px;'><b>Copyright &copy; 2015 | <a style='color: #0063CA;text-decoration:none;' href='http://example.forum.phoenixrealms.com'>Phoenix</a></b></p>
                        </td>
                    </tr>
                </table>
            </td>
...
";
                    ...
                    client.Credentials = new NetworkCredential("EMAILNOREPLY@PHOENIXREALMS.COM", "PASSWORDCREDS");
