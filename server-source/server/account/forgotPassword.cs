                ...
                <table width='650px' cellspacing='0' cellpadding='3' class='container' style='width:960px;'>
                    <tr>
                        <td align='center' style='font-size:12pt;'>
                            ...
                            <p style='height:80px;margin-bottom:35px;'><b>Copyright &copy; 2015 | <a style='color: #0063CA;text-decoration:none;' href='http://example.phoenixrealms.com'>Phoenix Realms</a> - Proph</b></p>
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            var client = new SmtpClient
                            {
                                ...
                                Credentials = new NetworkCredential("EMAILNOREPLY@PHOENIXREALMS.COM",
                                    "PASSWORDCREDS")
                            };
