...
namespace db
{
    ...
    {
        public string NamePrefix = ""; //works
        public string Name = ""; //works
        public string Description = "";
        public uint NameColor = 0xFFFFFF; //works
        public int FameBonus = 0; //wip

        public bool Soulbound = false; //works
        public bool MultiUse = false; //works
        public bool GivenItem = false; //wip

        public string TextureFile = ""; //works
        public uint TextureIndex = 0; //works

        public ConcurrentDictionary<string, int> StrangeParts = new ConcurrentDictionary<string, int>();

        public string Effect = ""; //works
        public string FullEffect = ""; //works
        ...
        public int DmgPercentage = 0; //works
        public int MinDamage = 0; //works
        public int MaxDamage = 0; //works
        public double Range = 0; //works
        public double FireRate = 0; //works
        public bool? MultiHit = null; //not done
        public bool? PassesCover = null; //not done

        public bool Strange = false; //works
        public int Kills = 0; //work

        public int CondChance = 0; //Percentage to apply CondEffect; not done
        public int CondEffect = -1; //Condition effect index; not done

        #endregion Weapons

        #region Abilities

        public int MPCost = 0; //Added MP Cost; not done
        ...
        public static List<string> StrangePartTypes = new List<string>()
        {
            "God Kills",
            "Quest Kills",
            "Oryx Kills",
