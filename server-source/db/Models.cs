...
{
    #region Game Stat Multipliers 
    //All multipliers are set to 1.0 as default
    public double GlobalHPMult { get; set; }
    public double GlobalDefMult { get; set; }
    public double GlobalResMult { get; set; }
    public double EnemyHPMult { get; set; }
    public double EnemyDefMult { get; set; }
    public double EnemyResMult { get; set; }
    public double LootChanceMult { get; set; }
    public double RareLootChanceMult { get; set; }
    public double ExpMult { get; set; }
    #endregion

    #region Game Restrictions
    public bool NoLootDrops { get; set; }
    public bool NoPortalDrops { get; set; }
    public bool NoTrading { get; set; }
    public bool SoulboundAll { get; set; } //overrides NoTrading
    public bool MarketplaceClosed { get; set; } //server.exe
    public bool RestrictPlayersToFriendly { get; set; }
    public bool RestrictPlayersToNexus { get; set; } //overrides RestrictPlayersToFriendly
    public bool HatBotIsSleeping { get; set; }
    public bool NoChat { get; set; } //overrides HatBotIsSleeping
    public bool NoItemUse { get; set; } //may DC players on shoot packet or UseAbility packet
    public bool RestrictGlobalProgress { get; set; }
    #endregion
}
