...
namespace wServer.logic.behaviors
{
                ...
                if (player != null || defaultAngle != null || fixedAngle != null)
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        Projectile prj = host.CreateProjectile(
                            desc, host.ObjectType, dmg, pen, time.TotalElapsedMs,
    ...
    internal class SpiralShoot : CycleBehavior
    {
        ...
        public SpiralShoot(double radius, int count = 1, double? shootAngle = null,
            int projectileIndex = 0,
            double angleOffset = 0, double defaultAngle = 0.0,
        ...
        protected override void TickCore(Entity host, RealmTime time, ref object state)
        {
            ...
            if (cool <= 0)
            {
                ...
                if (player != null)
                {
                    ...
                    double a = defaultAngle;
                        
                    a += (angleOffset * increments);
