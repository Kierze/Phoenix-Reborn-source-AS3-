    ...
    partial class BehaviorDb
    {
        private _ Shore = () => Behav()
            .Init("Pirate",
                new State(
                    new Prioritize(
                        new Follow(0.75, range: 1, duration: 5000, coolDown: 0),
                        new Wander(0.4)
                        ),
                    new Shoot(3, coolDown: 1800)
                    ),
                new TierLoot(1, ItemType.Weapon, 0.2),
                new ItemLoot("Health Potion", 0.03),
                new ItemLoot("Banana", 0.03)
            )
            .Init("Piratess",
                new State(
                    new Prioritize(
                        new Follow(0.85, range: 1, duration: 3000, coolDown: 1500),
                        new Wander(0.6)
                        ),
                    new Shoot(3, coolDown: 1800),
            ...
            .Init("Scorpion Queen",
                new State(
                    ...
                    new Shoot(8, 3, 45, coolDown: 2000),
            ...
            .Init("Bandit E",
                new State(
                    new State("fast_follow",
                        ...
                        new TimedTransition(2400, "scatter1")
                        ),
                    new State("scatter1",
                        new Prioritize(
                            new Protect(0.6, "Bandit Leader", 9, 7, 3),
                        ...
                        new TimedTransition(1600, "slow_follow")
                        ),
                    new State("slow_follow",
                        ...
                        new TimedTransition(2400, "scatter2")
                        ),
                    new State("scatter2",
                        new Prioritize(
                            new Protect(0.6, "Bandit Leader", 9, 7, 3),
                        ...
                        new TimedTransition(1600, "fast_follow")
                        ),
                    new State("escape",
                        new StayBack(0.5, 8),
                        new TimedTransition(12000, "fast_follow")
                        )
                    )
            )
            .Init("Bandit Leader",
                new State(
                    new Spawn("Bandit E", coolDown: 8000, maxChildren: 4),
                    new State("bold",
                        new State("warn_about_grenades",
                            new Taunt(0.15, "Catch!"),
                            new TimedTransition(300, "wimpy_grenade1")
                            ),
                        new State("wimpy_grenade1",
                            new Grenade(1.4, 12, 5, coolDown: 10000),
                            new Prioritize(
                                new StayAbove(0.3, 7),
                                new Wander(0.3)
                                ),
                            new TimedTransition(1600, "wimpy_grenade2")
                            ),
                        new State("wimpy_grenade2",
                            ...
                            new TimedTransition(2400, "slow_follow")
                            ),
                        new State("slow_follow",
                            ...
                            new TimedTransition(3200, "warn_about_grenades")
                            ),
                    ...
                    new State("meek",
                        ...
                        new StayBack(0.5, 6),
                        new Order(10, "Bandit E", "escape"),
                        new TimedTransition(9600, "bold")
                        )
                    ),
                new TierLoot(1, ItemType.Weapon, 0.2),
                new TierLoot(1, ItemType.Armor, 0.2),
            ...
            .Init("Red Gelatinous Cube",
                new State(
                    new SpawnOnDeath("Pirate Cave Portal", 0.02),
                    new Shoot(8, 2, 10, predictive: 0.2, coolDown: 800),
                    new Wander(0.4),
                    new Reproduce(densityMax: 5)
                    ),
            ...
            .Init("Purple Gelatinous Cube",
                new State(
                    new SpawnOnDeath("Pirate Cave Portal", 0.02),
                    new Shoot(8, predictive: 0.2, coolDown: 500),
                    new Wander(0.4),
                    new Reproduce(densityMax: 5)
                    ),
                new ItemLoot("Health Potion", 0.04),
            ...
            .Init("Green Gelatinous Cube",
                new State(
                    new SpawnOnDeath("Pirate Cave Portal", 0.02),
                    new Shoot(8, 5, 72, predictive: 0.2, coolDown: 1500),
                    new Wander(0.4),
                    new Reproduce(densityMax: 5)
                    ),
                new ItemLoot("Health Potion", 0.04),
