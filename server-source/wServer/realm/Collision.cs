...
namespace wServer.realm
{
    public class CollisionNode<T> where T : ICollidable<T>
    {
         ...
         */
            ...
            //chunk coords are in 8x8 grid?
            // also 8 kinds of collision map type
        public int Data;
    ...
    public class CollisionMap<T> where T : ICollidable<T>
    {
        ...
        public void Move(T obj, float newX, float newY)
        {
            ...
            if (obj.Parent != this)
                throw new InvalidOperationException("Cannot move object accros different map.");
        ...
        public void Remove(T obj)
        {
            if (obj.CollisionNode == null)
                return;
            if (obj.Parent != this)
                throw new InvalidOperationException("Cannot remove object acrose different map.");
