...
namespace wServer.realm
{
    ...
    public class RealmManager
    {
        ...
        public ConcurrentDictionary<int, World> Worlds = new ConcurrentDictionary<int, World>();
        ...
        public ChatBotCommandManager ChatBotCommands { get; private set; } //notice to change
        ...
        {
            Client dummy;
            Clients.TryRemove(client.Account.AccountId, out dummy);
            dummy?.Dispose();
        }
        ...
        private void OnWorldAdded(World world)
        {
            ...
            world.dungeon = !World.IsWorldStatic(world);
            log.InfoFormat("World {0}({1}) added. Dungeon = {2}", world.Id, world.Name, world.dungeon);
        }
